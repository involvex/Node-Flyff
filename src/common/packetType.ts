...
export enum PacketType {
  ...
  QUERY_DESTROY_CHARACTER = 0x00000030,
  NEW_ACCOUNT = 0x000000f0,
  DEL_ACCOUNT = 0x000000f1,
  CACHE_ADDR = 0x000000f2,
  CHARACTER_LIST = 0x000000f3,
  CREATE_CHARACTER = 0x000000f4,
  DELETE_CHARACTER = 0x000000f5,
  ...
  JOIN_GAME = 0x0000ff00,
  LEAVE_GAME = 0x0000ff01,
